...
public class GeoLocation {
	 ...
	 */
	public static GeoLocation fromDegrees(double latitude, double longitude) throws BusinessException {
	 ...
	 * @throws BusinessException 
	 */
	public static GeoLocation fromRadians(double latitude, double longitude) throws BusinessException {
		GeoLocation result = new GeoLocation();
	...
	private void checkBounds() throws BusinessException {
		if (radLat < MIN_LAT || radLat > MAX_LAT ||
				radLon < MIN_LON || radLon > MAX_LON){
		errorMessages.add("invalid range of langitude or longitude");
	...
	public GeoLocation[] boundingCoordinates(double distance, double radius) throws BusinessException {
