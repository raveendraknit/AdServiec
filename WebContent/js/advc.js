function EAS_load_fif(divId, fifSrc, easSrc, width, height) {
   ...
   var d = document,
       div = d.getElementById(divId),lat,lon,scr;

   while (div.hasChildNodes()) {
    div.removeChild(div.lastChild);
   }
   var fif = d.createElement("iframe");
   my_resize_fif(divId,width,height);
   fif.src = fifSrc;
...
function showPosition(position) {
    ...
    fif.EAS_src = easSrc + "&lat="+lat+"&lon="+lon+"&scr="+scr+"&fif=y";
    div.appendChild(fif);
...
function handleError(error){
   ...
   fif.EAS_src = easSrc +"&scr="+scr+"&fif=y";
...
function EAS_load_Custom(divId, fifSrc, easSrc, width, height,lat,lon) {
	
	
	   var d = document,
	   div = d.getElementById(divId),scr;
...
function my_resize_fif(divId, width, height)
{
   var d = document,
      div = d.getElementById(divId),
      fif = div.firstChild;
   if (fif) {
      fif.style.width = width;
      fif.style.height = height;
   }
